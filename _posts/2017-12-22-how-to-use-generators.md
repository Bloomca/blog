...
As you can see, we can easily change number of items in the chunk, throw this runner away and switch back to usual synchronous execution – and all of this won't affect our `renderItems` function.
